...
export class AppComponent {
  quotes = [
    ...
    new Quote(2, 'Fake it till you make it', 'By Thomas Daniels',new Date(2018,7,7)),
    ...
    new Quote(4, 'Only I can change my life.No one can do it for me', 'By Didier Deschamps',new Date(2018,7,9)),
  ]
}
